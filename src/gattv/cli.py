...
def server(config_path: Path = DEFAULT_CONFIG_PATH) -> None:
    ...
    table.add_row("Commands", "/start  /status  /arm  /disarm")
    ...
    console.print("[dim]Waiting for messages. Open Telegram and send /start to the bot.[/dim]")
